...
<section class="bnomio-hero">
    <div class="bnomio-hero--half artist-hero theme--artist">
        ...
        <div class="hero-link">
            ...
            <p class="link-text">Artist & Creative <span>consultant</span></p>
        ...
        <div class="hero-socials">
            <a href="https://www.instagram.com/bnomio" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Instagram">
        ...
        <div class="hero-content">
            ...
            <div class="content-projects">
                <?php foreach (array_slice($artist_featured_projects, 0, 6) as $project) : ?>
                    ...
                    $card_style_parts = [];
                    if (!empty($project_aspect)) {
                        $card_classes .= ' collection-card--custom-aspect';
                        $card_style_parts[] = '--card-aspect-ratio: ' . esc_attr($project_aspect);
                    }
    ...
    <div class="bnomio-hero--half studio-hero theme--studio">
        ...
        <div class="hero-link">
            <!-- <p class="link-text"><?php echo nl2br(esc_html($studio_intro_text)); ?></p> -->
             <p class="link-text">Nomad design <span>studio</span></p>
        ...
        <button class="back-tab home-back" aria-label="Back">
